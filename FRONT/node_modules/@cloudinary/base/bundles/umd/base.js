(function (global, factory) {
    ...
    ***************************************************************************** */
     ...
     * @see Visit {@link Actions.Resize| Resize} for examples
     */
    var ScaleAction = /** @class */ (function (_super) {
         ...
         * @return {this}
         */
        ScaleAction.prototype.liquidRescaling = function () {
    ...
    var DeliveryAction = /** @class */ (function (_super) {
         ...
         */
        function DeliveryAction(deliveryKey, deliveryType) {
            var _this = _super.call(this) || this;
    ...
    var DeliveryFormat = /** @class */ (function (_super) {
        __extends(DeliveryFormat, _super);
     ...
     * @see Visit {@link Actions.Delivery|Delivery} for an example
     */
    var DeliveryColorSpaceFromICC = /** @class */ (function (_super) {
        __extends(DeliveryColorSpaceFromICC, _super);
        /**
         * @param {string} publicId
         */
        function DeliveryColorSpaceFromICC(publicId) {
            var _this = _super.call(this) || this;
            var qualifierValue = new QualifierValue(['icc', publicId]).setDelimiter(':');
            _this.addQualifier(new Qualifier('cs', qualifierValue));
            return _this;
        }
        return DeliveryColorSpaceFromICC;
    }(Action));
    ...
    function expression(exp) {
        return new ExpressionQualifier(exp
            .toString()
            .split(" ")
            .map(function (val) { return CONDITIONAL_OPERATORS[val] || val; })
            .join("_"));
    }
    // as a namespace
    var Expression = {
    ...
    var FontStyle = { normal: normal$2, italic: italic };
    ...
    var OCR = /** @class */ (function (_super) {
        ...
        function OCR() {
            var _this = 
            // Required due to https://github.com/microsoft/TypeScript/issues/13029
            _super.call(this, 'ocr_text') /* istanbul ignore next */ || this;
            _this.qualifierValue.delimiter = '_';
            return _this;
        }
        /**
    ...
    var CloudinaryFile = /** @class */ (function () {
        ...
        CloudinaryFile.prototype.setStorageType = function (newType) {
        ...
        CloudinaryFile.prototype.getResourceType = function () {
            ...
            var shortSEOType = SEO_TYPES[assetType + "/" + storageType];
     ...
     */
    function v1NormalizeExpression(expression) {
        ...
        // @ts-ignore
        expression = expression.replace(predefinedVarsReplaceRE, function (match, p1, offset) { return (expression[offset - 1] === '$' ? match : V1_PREDEFINED_VARS[match]); });
    ...
    function processCustomPreFunction(customPreFunction) {
        var result = processCustomFunction(customPreFunction);
    ...
    function generateTransformationString(transformationOptions) {
        ...
        if (isObject(border)) {
            (border.width != null ? border.width : 2) + "px_solid_" + (border.color != null ? border.color : "black").replace(/^#/, 'rgb:');
        }
        ...
        (transformationOptions.variables || []).map(function (_a) {
            ...
            return name + "_" + v1NormalizeExpression(value);
        })).join(',');
        // Clean up!
    ...
    function createCloudinaryV1URL(public_id, transformationOptions) {
        var _a, _b;
        // Path format
    ...
    var CloudinaryBaseSDK = {
        ...
        createCloudinaryV1URL: createCloudinaryV1URL
    };

    exports.Actions = Actions;
    exports.Cloudinary = Cloudinary;
    exports.CloudinaryBaseSDK = CloudinaryBaseSDK;
    ...
    exports.createCloudinaryV1URL = createCloudinaryV1URL;
    exports.default = CloudinaryBaseSDK;
